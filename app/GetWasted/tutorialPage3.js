    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container_main}>
                ...
                <Text style={styles.smallText2}><Text  style={styles.bold}>READ</Text> about tips and tricks to reduce your waste.</Text>
                <Text style={styles.smallText2}><Text  style={styles.bold}>SHOP</Text> for items necessary for your journey.</Text>
                <Text style={styles.smallText2}><Text style={styles.bold}>SHARE</Text> with friends and learn from others.</Text>
