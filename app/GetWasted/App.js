...
export default class App extends Component<Props> {
    constructor(props) {
        ...
        this.state = {
            ...
            passwordConf:{value: null, valid: false},
            showSpinner:false,
            errorMessage: ''
        };
    ...
    handleSignUp(event) {
        ...
        firebaseApp.auth().createUserWithEmailAndPassword(this.state.email.value, this.state.password.value)
            .then((firebaseUser) => {
    ...
    render() {
        ...
        return (
            ...
            onChange={(e) => this.handleChange(e)}
                />
                {errors.mismatched &&
                 <p className="help-block error-mismatched">passwords dont match</p>
                }
            </div>
        );
    }
